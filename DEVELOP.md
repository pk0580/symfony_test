...
## Этап 2: Инициализация Symfony

1.  **Установка Symfony Skeleton**:
    *   Использование Symfony CLI или Composer для создания нового проекта внутри контейнера.
2.  **Настройка переменных окружения**:
    *   Конфигурация `.env` и `.env.local` для подключения к БД в Docker.
3.  **Установка необходимых бандлов**:
    *   `webapp` (для полноценного приложения) или отдельные компоненты по мере необходимости.
